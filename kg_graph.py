...
#读取实体-关系-实体三元组文件
with open(r"E:\八斗\第十六周 知识图谱\week16 知识图谱问答\kgqa_base_on_sentence_match\任贤齐e-e.txt", encoding="utf8") as f:
    for line in f:
...
#读取实体-属性-属性值三元组文件
with open(r"E:\八斗\第十六周 知识图谱\week16 知识图谱问答\kgqa_base_on_sentence_match\任贤齐e-a.txt", encoding="utf8") as f:
    for line in f:
...
with open("E:\八斗\第十六周 知识图谱\week16 知识图谱问答\kgqa_base_on_sentence_match\kg_rxq.json", "w", encoding="utf8") as f:
